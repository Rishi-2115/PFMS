...
public class ListRecentTransactions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listTransactionsss = (ListView) this.findViewById(R.id.listTransactions);

        listTransactionsss.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    protected void onStart() {
        ...
        try {
            ...
            listTransactionsss.setAdapter(adapter);
        }
        catch (Exception ex)
        {
